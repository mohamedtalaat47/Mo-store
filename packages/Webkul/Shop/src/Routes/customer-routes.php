...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    ...
    Route::group(['middleware' => ['cart.merger']], function () {
        Route::prefix('customer')->group(function () {
            ...
            //Route::get('login/google/redirect', [SessionController::class, 'googleLoginRedirect']);
            Route::get('login/google/redirect', function(){
                return Socialite::driver('google')->redirect();
            });


            Route::get('login/google/callback', [SessionController::class, 'googleLoginCallback']);
